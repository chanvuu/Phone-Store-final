...
public class Login extends JFrame implements MouseListener{
	...
	private static final char[] LoadataPassword = null;
	...
	public Login() {
		...
		gridBagLayout.columnWidths = new int[] {300, 400};
		...
		Login_button.setBackground(myColor);
	...
	public char[] LoadataPassword() {
		  char[] login_password=passwordField.getPassword();
